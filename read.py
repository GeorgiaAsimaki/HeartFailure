...
filename = 'C:/dtu/IntroToMLandDM/project/data/heart_failure_clinical_records_dataset.csv'
df = pd.read_csv(filename)

#Georgia : C:/dtu/IntroToMLandDM/project/data/heart_failure_clinical_records_dataset.csv
